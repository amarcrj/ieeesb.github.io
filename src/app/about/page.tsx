                  ...
                  <Card key={index} className="text-center group hover:shadow-lg transition-all">
                    <CardContent className="p-6">
                      <div className="mb-4 flex justify-center">
                        <div className="rounded-full bg-[#00629B] p-3">
                          <Icon className="h-8 w-8 text-white" />
                        </div>
                      </div>
                      <h3 className="mb-2 text-3xl font-bold text-[#00629B]">
                        {stat.number}
                      </h3>
        ...
        <section className="py-8 sm:py-12 lg:py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 sm:gap-12 lg:grid-cols-2">
              ...
              <div>
                <h2 className="mb-6 text-3xl font-bold text-[#00629B]">Our Vision</h2>
                <p className="mb-4 text-lg text-gray-700 leading-relaxed">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              {values.map((value, index) => {
                ...
                return (
                  <Card key={index} className="group h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 items-center">
              ...
              <div className="order-1 lg:order-2">
                <h2 className="mb-6 text-3xl font-bold text-[#00629B]">Our Rich History</h2>
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">1884 - Foundation</h3>
                    <p className="text-gray-700">
                      Founded as the American Institute of Electrical Engineers (AIEE)
                    </p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">1963 - IEEE Formation</h3>
                    <p className="text-gray-700">
                      AIEE merged with the Institute of Radio Engineers (IRE) to form IEEE
                    </p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Today - Global Impact</h3>
                    <p className="text-gray-700">
